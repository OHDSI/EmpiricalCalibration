...
#'                               function. If provided, the logRr, seLogRr, trueLogRr, and strata 
...
plotCiCalibration <- function(logRr,
  ...
  if (missing(evaluation) || is.null(evaluation)) {
    evaluation <- evaluateCiCalibration(logRr = logRr,
                                        seLogRr = seLogRr,
                                        trueLogRr = trueLogRr,
                                        strata = strata,
...
#' @export
plotErrorModel <- function(logRr, seLogRr, trueLogRr, title, fileName = NULL) {
