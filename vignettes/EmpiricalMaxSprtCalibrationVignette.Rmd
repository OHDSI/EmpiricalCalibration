...
It is always a good idea to compute the type 1 error based on the negative controls, to understand the operating characteristics of your study. Here we compute type 1 error both with and without calibration, to demonstrate why empirical calibration can be important.
